...
int osszkul(int n, int magassagok[]) {
    int osszeg = 0;
    for (int i = 0; i < n - 1; i++) {
        int kulonbseg = magassagok[i] - magassagok[i + 1];
        if (kulonbseg < 0) {
